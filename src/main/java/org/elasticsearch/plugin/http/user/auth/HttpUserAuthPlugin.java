...
public class HttpUserAuthPlugin extends Plugin {
	...
	/**
	 * Module decalaring some example configuration and a _cat action that uses it.
	 */
	public static class ConfiguredExampleModule extends AbstractModule {
		...
		protected void configure() {
			...
			Multibinder<BaseRestHandler> baseRestHandlerMultibinder = Multibinder.newSetBinder(binder(),
					BaseRestHandler.class);
			baseRestHandlerMultibinder.addBinding().to(AuthRestHandler.class).asEagerSingleton();
		}
	}
}
